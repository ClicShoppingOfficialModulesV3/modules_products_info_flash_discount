<?php
/**
 * pi_products_info_flash_discount.php 
 ...
 */
  ...
  class pi_products_info_flash_discount {
    public $code;
    public $group;
    public $title;
    public $description;
    ...
    public function execute() {
      ...
      if (isset($_GET['products_id']) && isset($_GET['Products']) ) {
        ...
        if (!empty($products_flash_discount) ) {
          ...
          $CLICSHOPPING_Template->addBlock($products_flash_discount_content, $this->group);
        }
      }
    } // public function execute
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_FLASH_DISCOUNT_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_FLASH_DISCOUNT_CONTENT_WIDTH',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_FLASH_DISCOUNT_POSITION',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_FLASH_DISCOUNT_SORT_ORDER',
    ...
    public function keys() {
      return array (
        ...
        'MODULE_PRODUCTS_INFO_FLASH_DISCOUNT_SORT_ORDER'
      );
    }
  }
